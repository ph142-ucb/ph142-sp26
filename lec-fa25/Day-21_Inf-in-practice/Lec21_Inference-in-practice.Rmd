...
library(ggplot2)
num_samples <- 10
z_val <- qnorm(p = 0.05, mean = 0, sd = 1/sqrt(num_samples), lower.tail = F) # 0.5201484
ggplot(data = data.frame(x = c(-1.3, 2)), aes(x)) + 
    geom_area(stat = "function", fun = dnorm, args = list(mean = 0, sd = 1/sqrt(num_samples)), 
            fill = "red", xlim = c(z_val, 2)) +
  stat_function(fun = dnorm, n = 101, args = list(mean = 0, sd = 1/sqrt(num_samples))) +
  labs(y = "density") + 
  theme_minimal(base_size = 15) +
  labs(title = "Calculating power") +
  geom_area(stat = "function", fun = dnorm, args = list(mean = 0.8, sd = 1/sqrt(num_samples)), 
            fill = "blue", xlim = c(z_val, 2.0), alpha = 0.5) +
  stat_function(fun = dnorm, n = 101, args = list(mean = 0.8, sd = 1/sqrt(num_samples))) +
  annotate('text', x = 0, y = 1.2, label = "H[o]", check_overlap = T, parse=TRUE) +
  annotate('text', x = 0.8, y = 1.2, label = "H[a]", check_overlap = T, parse=TRUE)
...
ggplot(data = data.frame(x = c(-1.3, 2)), aes(x)) + 
  ...
  labs(y = "density") + 
  theme_minimal(base_size = 15) +
  labs(title = "Calculating power: n = 14") +
  geom_area(stat = "function", fun = dnorm, args = list(mean = 0.8, sd = 1/sqrt(num_samples)), 
            fill = "blue", xlim = c(z_val, 2.0), alpha = 0.5) +
  stat_function(fun = dnorm, n = 101, args = list(mean = 0.8, sd = 1/sqrt(num_samples))) +
  annotate('text', x = 0, y = 1.2, label = "H[o]", check_overlap = T, parse=TRUE) +
...
::::
:::
### How power changes for smaller vs. larger sample sizes
...
ggplot(data = data.frame(x = c(-1.3, 2)), aes(x)) + 
  ...
  labs(y = "density") + 
  theme_minimal(base_size = 15) +
  labs(title = "Calculating power: n = 5") +
  geom_area(stat = "function", fun = dnorm, args = list(mean = 0.8, sd = 1/sqrt(num_samples)), 
            fill = "blue", xlim = c(z_val, 2.0), alpha = 0.5) +
  stat_function(fun = dnorm, n = 101, args = list(mean = 0.8, sd = 1/sqrt(num_samples))) +
  annotate('text', x = 0, y = 1.2, label = "H[o]", check_overlap = T, parse=TRUE) +
...
ggplot(data = data.frame(x = c(-1.3, 2)), aes(x)) + 
  ...
  labs(y = "density") + 
  theme_minimal(base_size = 15) +
  labs(title = "Calculating power: n = 25") +
  geom_area(stat = "function", fun = dnorm, args = list(mean = 0.8, sd = 1/sqrt(num_samples)), 
            fill = "blue", xlim = c(z_val, 2.0), alpha = 0.5) +
  stat_function(fun = dnorm, n = 101, args = list(mean = 0.8, sd = 1/sqrt(num_samples))) +
  annotate('text', x = 0, y = 1.2, label = "H[o]", check_overlap = T, parse=TRUE) +
