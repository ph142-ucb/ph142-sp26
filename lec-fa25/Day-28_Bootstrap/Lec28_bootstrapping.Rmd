...
to estimate the CI, such that the sample is "pulling itself up by its own bootstraps"
...
- If we truly have an SRS from the underlying population, this means that the 
...
::: columns
:::: column
```{r, fig.align="centre", out.width="100%"}
...
- How to examine whether this procedure would result in a CI with 95\% coverage?
::::

:::: column
```{r, fig.align="centre", out.width="100%", echo = F}
fig
```
:::: 
:::
