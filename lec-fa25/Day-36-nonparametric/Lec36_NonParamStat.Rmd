...
```{r, echo=TRUE, out.width="40%", fig.align='center', message=FALSE, warning=FALSE}
...
:::: column
Note the central peak in the data.
::::
:::
...
::: columns
:::: column
- Our sample size is 13 (one pair is thrown out for having a difference of zero)
- Note the $t$-test had more power due to the data having a symmetric peak
- The distribution of change is plotted as a histogram
::::

:::: column
```{r wtot, echo=TRUE, out.width="100%", fig.align='center',out.height="50%"}
hist(Change)
```
::::
:::
