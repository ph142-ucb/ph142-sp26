...
* Online resource: [Creating a `ggplot`](https://r4ds.hadley.nz/data-visualize.html)

### Life expectancy in the United States by race and gender, 1969-2013 

These data are partial results from a study that Dr. Corinne Riddell did on the difference in life 
...
- Ask questions during lab section, GSI & instructor office hours, or on Ed discussion forum. Use the appropriate thread!
...
- The most common links that will appear are:
    - https://stackoverflow.com: Crowd-sourced answers, mostly focused on software engineering, that have been upvoted. The top answer is often the best one.
    - https://stats.stackexchange.com: Cross Validated. Like Stack Overflow, but focused on statistics and data science
    - https://ggplot2.tidyverse.org/: The official ggplot2 webpage is very helpful
    - https://forum.posit.co/: The Posit (formerly RStudio) community forum
...
- Here is some extra material for those of you who love data visualization. This material won't be tested.
    - [RStudio ggplot2 cheatsheet](https://rstudio.github.io/cheatsheets/html/data-visualization.html)
    - [Kieran Healy's data visualization book](https://www.amazon.com/gp/product/0691181624/)
