...
This means we can transform its distribution from being centered at $\mu$ with a 
standard deviation of $\sigma$ to another Normal distribution with $\mu=0$ and
...
In this image, the solid red line shows the average birth weight as a function 
of gestational age for boys and girls.

What is the approximate average birth weight in kilograms for a boy delivered at 
33 weeks?
