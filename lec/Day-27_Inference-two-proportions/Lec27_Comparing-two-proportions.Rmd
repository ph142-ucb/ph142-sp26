...
$\tilde{p}_1 = \frac{\text{(no. of successes in population 1) + 1}}{n_1 + 2} = \frac{\hat{p}_1n_1 + 1}{n_1 + 2}$

$\tilde{p}_2 = \frac{\text{(no. of successes in population 2) + 1}}{n_2 + 2} = \frac{\hat{p}_2n_2 + 1}{n_2 + 2}$
...
$\big(\frac{5}{102} - \frac{12}{102}\big) \pm 1.96\times0.0384$ = -0.6% to 14.4%
...
case, our best estimate of the two equal underlying proportions is called the pooled sample proportion:
...
for the SE for the difference between the two proportions and substituting in 
$\hat{p}$ for $p_1$ and $p_2$:

$\sqrt{\frac{\hat{p}(1-\hat{p})}{n_1} + \frac{\hat{p}(1-\hat{p})}{n_2}}$

$\sqrt{\hat{p}(1-\hat{p})\big(\frac{1}{n_1}+\frac{1}{n_2}\big)}$
...
$$z = \frac{\hat{p}_1 - \hat{p}_2}{\sqrt{\hat{p}(1-\hat{p})\Big(\frac{1}{n_1} + \frac{1}{n_2}\Big)}}$$
...
- This is an extreme example where the it would be dubious to rely on large sample CIs
