...
subtitle: Chapter 14
author: "Corinne Riddell (Instructor Mi-Suk Kang Dufour)"
...
### Two-sided hypothesis test $p$-value calculation
...
arbitrary cut-off. It is much better to report the exact value of the $p$-value than
...
### Population mean $z$ test (continued)
...
Note that for each of the following alternative hypotheses we assume a different example $z$-score, which is why we don't use $-z$ for the case where $\mu < \mu_0$.
